...
var arrAfri = ['NBA-sky','DPT-sky','CAI-sky','LOS-sky','CMN-sky','DUR-sky','ACC-sky','NBOA-sky','DKRA-sky','EBB-sky'];
   ...
   function pullFlightData(arr){
       for (var i = 0; i < arr.length; i++) {
           var settings = {
               'async': true,
               'crossDomain': true,
               'url': 'https://skyscanner-skyscanner-flight-search-v1.p.rapidapi.com/apiservices/pricing/uk2/v1.0/'+arr[i]+'?pageIndex=0&pageSize=10',
               'method': 'GET',
               'headers': {
                   'x-rapidapi-host': 'skyscanner-skyscanner-flight-search-v1.p.rapidapi.com',
                   'x-rapidapi-key': '2abdcd6419msh8f3bf70becc33fdp1c08cfjsn573940caba1d'
