const newLocal = "https://skyscanner-skyscanner-flight-search-v1.p.rapidapi.com/apiservices/autosuggest/v1.0/US/USD/en-GB/?query=";
    ...
    $("#text_value").on("click", function(event) {
        ...
        if(fromLoc == '' || toLoc == '' || outBound == '' || inBound == '') {
            ...
            var priceSettings = {
                ...
                "url": "https://skyscanner-skyscanner-flight-search-v1.p.rapidapi.com/apiservices/browsequotes/v1.0/US/USD/en-US/CHIA-sky/LOND-sky/2019-11-11?inboundpartialdate=2019-12-01",
                "method": "GET",
                "headers": {
                    "x-rapidapi-host": "skyscanner-skyscanner-flight-search-v1.p.rapidapi.com",
                    "x-rapidapi-key": "2abdcd6419msh8f3bf70becc33fdp1c08cfjsn573940caba1d"
            ...
            console.log("https://skyscanner-skyscanner-flight-search-v1.p.rapidapi.com/apiservices/browsequotes/v1.0/US/USD/en-US/"+fromLoc+"/"+toLoc+"/"+outBound+"?inboundpartialdate="+inBound);
